...
public class Reihe {
    public static void main(String[] args) {
        ...
        System.out.println("Reihe 1/2: " + geometrischeReihe(1.0/2.0));
        System.out.println("Reihe 1/3: " + geometrischeReihe(1.0/3.0));
        System.out.println("Reihe 99/100: " + geometrischeReihe(99/100.0));
        System.out.println("Reihe 2: " + geometrischeReihe(100));
        System.out.println("Reihe 100: " + geometrischeReihe(2));


        System.out.println("Die Grenzwerte für:");
        System.out.println("1/2: " + grenzwert(1.0/2.0));
